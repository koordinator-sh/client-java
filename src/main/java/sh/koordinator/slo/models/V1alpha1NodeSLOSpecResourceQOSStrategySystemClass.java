 ...
 */
@ApiModel(description = "ResourceQOS for system pods")
...
public class V1alpha1NodeSLOSpecResourceQOSStrategySystemClass {
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategySystemClass blkioQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassBlkioQOS blkioQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategySystemClass cpuQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassCpuQOS cpuQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategySystemClass memoryQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassMemoryQOS memoryQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategySystemClass resctrlQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassResctrlQOS resctrlQOS) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1NodeSLOSpecResourceQOSStrategySystemClass v1alpha1NodeSLOSpecResourceQOSStrategySystemClass = (V1alpha1NodeSLOSpecResourceQOSStrategySystemClass) o;
    return Objects.equals(this.blkioQOS, v1alpha1NodeSLOSpecResourceQOSStrategySystemClass.blkioQOS) &&
        Objects.equals(this.cpuQOS, v1alpha1NodeSLOSpecResourceQOSStrategySystemClass.cpuQOS) &&
        Objects.equals(this.memoryQOS, v1alpha1NodeSLOSpecResourceQOSStrategySystemClass.memoryQOS) &&
        Objects.equals(this.resctrlQOS, v1alpha1NodeSLOSpecResourceQOSStrategySystemClass.resctrlQOS);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1NodeSLOSpecResourceQOSStrategySystemClass {\n");

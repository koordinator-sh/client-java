 ...
 */
@ApiModel(description = "ResourceQOS for BE pods.")
...
public class V1alpha1NodeSLOSpecResourceQOSStrategyBeClass {
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyBeClass blkioQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassBlkioQOS blkioQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyBeClass cpuQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassCpuQOS cpuQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyBeClass memoryQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassMemoryQOS memoryQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyBeClass resctrlQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassResctrlQOS resctrlQOS) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1NodeSLOSpecResourceQOSStrategyBeClass v1alpha1NodeSLOSpecResourceQOSStrategyBeClass = (V1alpha1NodeSLOSpecResourceQOSStrategyBeClass) o;
    return Objects.equals(this.blkioQOS, v1alpha1NodeSLOSpecResourceQOSStrategyBeClass.blkioQOS) &&
        Objects.equals(this.cpuQOS, v1alpha1NodeSLOSpecResourceQOSStrategyBeClass.cpuQOS) &&
        Objects.equals(this.memoryQOS, v1alpha1NodeSLOSpecResourceQOSStrategyBeClass.memoryQOS) &&
        Objects.equals(this.resctrlQOS, v1alpha1NodeSLOSpecResourceQOSStrategyBeClass.resctrlQOS);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1NodeSLOSpecResourceQOSStrategyBeClass {\n");

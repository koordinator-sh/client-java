 ...
 */
@ApiModel(description = "ResourceQOS for LS pods.")
...
public class V1alpha1NodeSLOSpecResourceQOSStrategyLsClass {
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyLsClass blkioQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassBlkioQOS blkioQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyLsClass cpuQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassCpuQOS cpuQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyLsClass memoryQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassMemoryQOS memoryQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyLsClass resctrlQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassResctrlQOS resctrlQOS) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1NodeSLOSpecResourceQOSStrategyLsClass v1alpha1NodeSLOSpecResourceQOSStrategyLsClass = (V1alpha1NodeSLOSpecResourceQOSStrategyLsClass) o;
    return Objects.equals(this.blkioQOS, v1alpha1NodeSLOSpecResourceQOSStrategyLsClass.blkioQOS) &&
        Objects.equals(this.cpuQOS, v1alpha1NodeSLOSpecResourceQOSStrategyLsClass.cpuQOS) &&
        Objects.equals(this.memoryQOS, v1alpha1NodeSLOSpecResourceQOSStrategyLsClass.memoryQOS) &&
        Objects.equals(this.resctrlQOS, v1alpha1NodeSLOSpecResourceQOSStrategyLsClass.resctrlQOS);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1NodeSLOSpecResourceQOSStrategyLsClass {\n");

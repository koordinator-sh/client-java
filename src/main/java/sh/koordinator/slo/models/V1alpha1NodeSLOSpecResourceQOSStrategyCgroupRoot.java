 ...
 */
@ApiModel(description = "ResourceQOS for root cgroup.")
...
public class V1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot {
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot blkioQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassBlkioQOS blkioQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot cpuQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassCpuQOS cpuQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot memoryQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassMemoryQOS memoryQOS) {
  ...
  **/
  ...
  public V1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot resctrlQOS(V1alpha1NodeSLOSpecResourceQOSStrategyBeClassResctrlQOS resctrlQOS) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot v1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot = (V1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot) o;
    return Objects.equals(this.blkioQOS, v1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot.blkioQOS) &&
        Objects.equals(this.cpuQOS, v1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot.cpuQOS) &&
        Objects.equals(this.memoryQOS, v1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot.memoryQOS) &&
        Objects.equals(this.resctrlQOS, v1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot.resctrlQOS);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1NodeSLOSpecResourceQOSStrategyCgroupRoot {\n");

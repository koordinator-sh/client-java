 ...
 */
@ApiModel(description = "PodRef represents the Pod that be migrated")
...
public class V1alpha1PodMigrationJobSpecPodRef {
  ...
  public V1alpha1PodMigrationJobSpecPodRef apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecPodRef fieldPath(String fieldPath) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecPodRef kind(String kind) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecPodRef name(String name) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecPodRef namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecPodRef resourceVersion(String resourceVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecPodRef uid(String uid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodMigrationJobSpecPodRef v1alpha1PodMigrationJobSpecPodRef = (V1alpha1PodMigrationJobSpecPodRef) o;
    return Objects.equals(this.apiVersion, v1alpha1PodMigrationJobSpecPodRef.apiVersion) &&
        Objects.equals(this.fieldPath, v1alpha1PodMigrationJobSpecPodRef.fieldPath) &&
        Objects.equals(this.kind, v1alpha1PodMigrationJobSpecPodRef.kind) &&
        Objects.equals(this.name, v1alpha1PodMigrationJobSpecPodRef.name) &&
        Objects.equals(this.namespace, v1alpha1PodMigrationJobSpecPodRef.namespace) &&
        Objects.equals(this.resourceVersion, v1alpha1PodMigrationJobSpecPodRef.resourceVersion) &&
        Objects.equals(this.uid, v1alpha1PodMigrationJobSpecPodRef.uid);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodMigrationJobSpecPodRef {\n");

...
public class V1alpha1ReservationStatusCurrentOwners {
  ...
  public V1alpha1ReservationStatusCurrentOwners apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1ReservationStatusCurrentOwners fieldPath(String fieldPath) {
  ...
  **/
  ...
  public V1alpha1ReservationStatusCurrentOwners kind(String kind) {
  ...
  **/
  ...
  public V1alpha1ReservationStatusCurrentOwners name(String name) {
  ...
  **/
  ...
  public V1alpha1ReservationStatusCurrentOwners namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1ReservationStatusCurrentOwners resourceVersion(String resourceVersion) {
  ...
  **/
  ...
  public V1alpha1ReservationStatusCurrentOwners uid(String uid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ReservationStatusCurrentOwners v1alpha1ReservationStatusCurrentOwners = (V1alpha1ReservationStatusCurrentOwners) o;
    return Objects.equals(this.apiVersion, v1alpha1ReservationStatusCurrentOwners.apiVersion) &&
        Objects.equals(this.fieldPath, v1alpha1ReservationStatusCurrentOwners.fieldPath) &&
        Objects.equals(this.kind, v1alpha1ReservationStatusCurrentOwners.kind) &&
        Objects.equals(this.name, v1alpha1ReservationStatusCurrentOwners.name) &&
        Objects.equals(this.namespace, v1alpha1ReservationStatusCurrentOwners.namespace) &&
        Objects.equals(this.resourceVersion, v1alpha1ReservationStatusCurrentOwners.resourceVersion) &&
        Objects.equals(this.uid, v1alpha1ReservationStatusCurrentOwners.uid);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1ReservationStatusCurrentOwners {\n");

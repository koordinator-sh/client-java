...
import sh.koordinator.scheduling.models.V1alpha1PodMigrationJobSpecDeleteOptionsPreconditions;

/**
 * DeleteOptions defines the deleting options for the migrated Pod and preempted Pods
 */
@ApiModel(description = "DeleteOptions defines the deleting options for the migrated Pod and preempted Pods")
...
public class V1alpha1PodMigrationJobSpecDeleteOptions {
  ...
  private V1alpha1PodMigrationJobSpecDeleteOptionsPreconditions preconditions;
  ...
  public V1alpha1PodMigrationJobSpecDeleteOptions apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecDeleteOptions dryRun(List<String> dryRun) {
    
    this.dryRun = dryRun;
    return this;
  }

  public V1alpha1PodMigrationJobSpecDeleteOptions addDryRunItem(String dryRunItem) {
    if (this.dryRun == null) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecDeleteOptions gracePeriodSeconds(Long gracePeriodSeconds) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecDeleteOptions kind(String kind) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecDeleteOptions orphanDependents(Boolean orphanDependents) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecDeleteOptions preconditions(V1alpha1PodMigrationJobSpecDeleteOptionsPreconditions preconditions) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobSpecDeleteOptionsPreconditions getPreconditions() {
    return preconditions;
  }


  public void setPreconditions(V1alpha1PodMigrationJobSpecDeleteOptionsPreconditions preconditions) {
    this.preconditions = preconditions;
  }


  public V1alpha1PodMigrationJobSpecDeleteOptions propagationPolicy(String propagationPolicy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodMigrationJobSpecDeleteOptions v1alpha1PodMigrationJobSpecDeleteOptions = (V1alpha1PodMigrationJobSpecDeleteOptions) o;
    return Objects.equals(this.apiVersion, v1alpha1PodMigrationJobSpecDeleteOptions.apiVersion) &&
        Objects.equals(this.dryRun, v1alpha1PodMigrationJobSpecDeleteOptions.dryRun) &&
        Objects.equals(this.gracePeriodSeconds, v1alpha1PodMigrationJobSpecDeleteOptions.gracePeriodSeconds) &&
        Objects.equals(this.kind, v1alpha1PodMigrationJobSpecDeleteOptions.kind) &&
        Objects.equals(this.orphanDependents, v1alpha1PodMigrationJobSpecDeleteOptions.orphanDependents) &&
        Objects.equals(this.preconditions, v1alpha1PodMigrationJobSpecDeleteOptions.preconditions) &&
        Objects.equals(this.propagationPolicy, v1alpha1PodMigrationJobSpecDeleteOptions.propagationPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodMigrationJobSpecDeleteOptions {\n");

 ...
 */
@ApiModel(description = "PodRef represents the newly created Pod after being migrated")
...
public class V1alpha1PodMigrationJobStatusPodRef {
  ...
  public V1alpha1PodMigrationJobStatusPodRef apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPodRef fieldPath(String fieldPath) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPodRef kind(String kind) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPodRef name(String name) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPodRef namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPodRef resourceVersion(String resourceVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPodRef uid(String uid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodMigrationJobStatusPodRef v1alpha1PodMigrationJobStatusPodRef = (V1alpha1PodMigrationJobStatusPodRef) o;
    return Objects.equals(this.apiVersion, v1alpha1PodMigrationJobStatusPodRef.apiVersion) &&
        Objects.equals(this.fieldPath, v1alpha1PodMigrationJobStatusPodRef.fieldPath) &&
        Objects.equals(this.kind, v1alpha1PodMigrationJobStatusPodRef.kind) &&
        Objects.equals(this.name, v1alpha1PodMigrationJobStatusPodRef.name) &&
        Objects.equals(this.namespace, v1alpha1PodMigrationJobStatusPodRef.namespace) &&
        Objects.equals(this.resourceVersion, v1alpha1PodMigrationJobStatusPodRef.resourceVersion) &&
        Objects.equals(this.uid, v1alpha1PodMigrationJobStatusPodRef.uid);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodMigrationJobStatusPodRef {\n");

...
public class V1alpha1PodMigrationJobStatusPreemptedPodsRef {
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodsRef apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodsRef fieldPath(String fieldPath) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodsRef kind(String kind) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodsRef name(String name) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodsRef namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodsRef resourceVersion(String resourceVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodsRef uid(String uid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodMigrationJobStatusPreemptedPodsRef v1alpha1PodMigrationJobStatusPreemptedPodsRef = (V1alpha1PodMigrationJobStatusPreemptedPodsRef) o;
    return Objects.equals(this.apiVersion, v1alpha1PodMigrationJobStatusPreemptedPodsRef.apiVersion) &&
        Objects.equals(this.fieldPath, v1alpha1PodMigrationJobStatusPreemptedPodsRef.fieldPath) &&
        Objects.equals(this.kind, v1alpha1PodMigrationJobStatusPreemptedPodsRef.kind) &&
        Objects.equals(this.name, v1alpha1PodMigrationJobStatusPreemptedPodsRef.name) &&
        Objects.equals(this.namespace, v1alpha1PodMigrationJobStatusPreemptedPodsRef.namespace) &&
        Objects.equals(this.resourceVersion, v1alpha1PodMigrationJobStatusPreemptedPodsRef.resourceVersion) &&
        Objects.equals(this.uid, v1alpha1PodMigrationJobStatusPreemptedPodsRef.uid);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodMigrationJobStatusPreemptedPodsRef {\n");

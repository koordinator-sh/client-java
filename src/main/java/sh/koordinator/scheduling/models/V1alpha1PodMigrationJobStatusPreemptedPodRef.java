 ...
 */
@ApiModel(description = "PreemptedPodRef represents the Pod that be preempted")
...
public class V1alpha1PodMigrationJobStatusPreemptedPodRef {
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodRef apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodRef fieldPath(String fieldPath) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodRef kind(String kind) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodRef name(String name) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodRef namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodRef resourceVersion(String resourceVersion) {
  ...
  **/
  ...
  public V1alpha1PodMigrationJobStatusPreemptedPodRef uid(String uid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodMigrationJobStatusPreemptedPodRef v1alpha1PodMigrationJobStatusPreemptedPodRef = (V1alpha1PodMigrationJobStatusPreemptedPodRef) o;
    return Objects.equals(this.apiVersion, v1alpha1PodMigrationJobStatusPreemptedPodRef.apiVersion) &&
        Objects.equals(this.fieldPath, v1alpha1PodMigrationJobStatusPreemptedPodRef.fieldPath) &&
        Objects.equals(this.kind, v1alpha1PodMigrationJobStatusPreemptedPodRef.kind) &&
        Objects.equals(this.name, v1alpha1PodMigrationJobStatusPreemptedPodRef.name) &&
        Objects.equals(this.namespace, v1alpha1PodMigrationJobStatusPreemptedPodRef.namespace) &&
        Objects.equals(this.resourceVersion, v1alpha1PodMigrationJobStatusPreemptedPodRef.resourceVersion) &&
        Objects.equals(this.uid, v1alpha1PodMigrationJobStatusPreemptedPodRef.uid);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodMigrationJobStatusPreemptedPodRef {\n");
